...
local wordsToReplaceOverrides = {["idiot"] = "chicken"}
...
local wordsToReplace = {
    ...
    "bareback", "barely legal", "barenaked", "bastard", "bastardo", "bastinado",
    "bbw", "bdsm", "beaner", "beaners", "beaver cleaver", "beaver lips",
    "beastiality", "bestiality", "big black", "big breasts", "big knockers",
    "big tits", "bimbos", "birdlock", "bitch", "bitches", "black cock",
    ...
    "busty", "butt", "buttcheeks", "butthole", "camel toe", "camgirl",
    "camslut", "camwhore", "carpet muncher", "carpetmuncher",
    "chocolate rosebuds", "cialis", "circlejerk", "cleveland steamer", "clit",
    "clitoris", "clover clamps", "clusterfuck", "cock", "cocks", "coprolagnia",
    "coprophilia", "cornhole", "coon", "coons", "creampie", "cum", "cumming",
    "cumshot", "cumshots", "cunnilingus", "cunt", "darkie", "date rape",
    "daterape", "deep throat", "deepthroat", "dendrophilia", "dick", "dickhead", "dildo",
    "dingleberry", "dingleberries", "dirty pillows", "dirty sanchez", "dog", 
    "doggie style", "doggiestyle", "doggy style", "doggystyle", "dog style",
    "dolcett", "domination", "dominatrix", "dommes", "donkey punch",
    "double dong", "double penetration", "dp action", "dry hump", "dvda", "dumbass", "dumbarse", "dumb",
    "eat my ass", "ecchi", "ejaculation", "erotic", "erotism", "escort",
    "eunuch", "fag", "faggot", "fecal", "felch", "fellatio", "feltch",
    "female squirting", "femdom", "figging", "fingerbang", "fingering",
    "fisting", "foot fetish", "footjob", "frotting", "fuck", "fucker", "fuck buttons",
    "fuckin", "fucking", "fucktards", "fudge packer", "fudgepacker", "futanari",
    ...
    "masturbation", "menage a trois", "milf", "missionary position", "mong",
    ...
    "pornography", "prick", "prince albert piercing", "pthc", "pubes", "pussy",
    "queaf", "queef", "quim", "rat", "raghead", "raging boner", "rape", "raping",
    ...
    "vulva", "wank", "wanka", "wanker", "wetback", "wet dream", "white power", "whore", "worldsex",
    "wrapping men", "wrinkled starfish", "xx", "xxx", "yaoi", "yellow showers",
    "yiffy", "zoophilia"
}

NS.ReplacementPreferences.replacementString = replacementString
NS.ReplacementPreferences.wordsToReplaceOverrides = wordsToReplaceOverrides
NS.ReplacementPreferences.wordsToReplace = wordsToReplace
